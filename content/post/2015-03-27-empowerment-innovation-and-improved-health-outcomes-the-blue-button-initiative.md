...
summary: 'Finding and getting access to our own health information can be a complex process. And most of us don&rsquo;t really think about having our health information readily accessible until we really need it — like in the event of an emergency, or when switching doctors or traveling. Combing through stacks of paperwork and contacting providers'
authors: [awichman]
categories:
  - API
  - Code

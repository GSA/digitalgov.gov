...
title: 'CareerOneStop’sNewest Online Resources\: Targeted to User Needs'
summary: ' When the Employment and Training Administration’sCareerOneStop team embarked on a redesign of the site’sonline career, training, and job resources, they didn&rsquo;t dive right into the technical work. Instead, they embraced a user-centered approach that focused on the user experience (UX). Focusing on&nbsp;UX means taking a step back to'

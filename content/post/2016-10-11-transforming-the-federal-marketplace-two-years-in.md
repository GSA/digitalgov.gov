...
summary: 'Summary\: It’sbeen two years since we laid out the Administration’splan to transform the Federal marketplace. Here’sa look at what we&rsquo;ve accomplished, and what’snext. Over the last two years, we&rsquo;ve focused on our mission to implement the President’svision for a modern government&amp;#8211; one that leverages private-sector best practices to achieve a'
authors: [anne-rung]
categories:
  - 'Strategy and Policy'
tag:

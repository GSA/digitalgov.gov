...
{% include image/full-width.html img="https://www.WHATEVER/files/2017/03/600-x-400-01\_chaski\_game\_in\_gallery_v2.jpg" alt="Photo of The Chaski Relay as it appears in the gallery." %}
...
{% include image/full-width.html img="https://www.WHATEVER/files/2017/03/600-x-337-02\_chaski\_screen_shot.jpg" alt="Screenshot from the game." %}
...
{% include image/full-width.html img="https://www.WHATEVER/files/2017/03/600-x-440-600-x-440-03\_chaski\_testing.jpg" alt="Photo of student user testing in the galleries." %}
...
{% include image/full-width.html img="https://www.WHATEVER/files/2017/03/600-x-207-04\_chaski\_character_model.jpg" alt="Image of a 3-D character model used to illustrate and animate the chaski runners used in the game." %}
...
_Explore DigitalGov for more information on how federal agencies are working with_ [_user experience_](https://www.WHATEVER/category/ux/) _(UX) and_ [_user testing_](https://www.WHATEVER/category/ux/user-testing-research/)_,_ [_gamification_](https://www.WHATEVER/tag/gamification/)_, and_ [_multilingual content_](https://www.WHATEVER/tag/multilingual/) _to better serve their customers. If you have a .gov or .mil email address, check out and join our_ [_Communities of Practice_](https://www.WHATEVER/communities/) _to connect with other feds working in these fields._
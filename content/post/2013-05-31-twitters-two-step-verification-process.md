...
summary: 'To enhance security, Twitter now offers&nbsp;two-step verification. The release of the new feature follows several high-profile account breaches — including a&nbsp;false tweet sent from the Associated Press’s Twitter account&nbsp;in April. If you chose to enable the two-step verification feature, Twitter sends a text message with a unique code to a cell phone that must be'
authors: [jason-kelly]
categories:
  - Social Media
tag:

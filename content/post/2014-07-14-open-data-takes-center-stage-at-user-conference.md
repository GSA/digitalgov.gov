...
Users are also starting to take Census data into the third dimension; for example, in a [November 2013 blog post](http://www.synthicity.com/blog/2014/5/12/introducing-geocanvas-a-generic-spatial-data-viewer-with-integrated-census-data), Synthicity used Census population data with its GeoCanvas, a platform that enables users to see their city via 3D data visualization. Following the first-ever National Day of Civic Hacking (June 1-2, 2013), Jerome Maurey-Delaunay brought Census data to life when he created a [3D model](https://github.com/jeromemaurey/ndoch2013) portraying income across Miami-Dade County using Census 2010 income statistics. * 

...
summary: ' The FTC’s second Spanish-language fotonovela is about scams that promise you can make money selling high-end products or brand-name merchandise. If the pitch sounds familiar, that’s because the story is based on facts from a recent [Federal Trade Commission]&nbsp;FTC lawsuit against a company'
authors: [alvaro-puig]
categories:
  - Content
  - Writing

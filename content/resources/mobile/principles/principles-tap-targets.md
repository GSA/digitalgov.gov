...
2. <strong>Use a base font size of 16 <a href="http://xahlee.info/js/web_design_screen_density.html">CSS pixels</a></strong> <br /><br />
...
3. <strong>Use font sizes relative to the base size to define the typographic scale</strong> <br /><br />
...
4. <strong>Restrict the number of fonts used and the typographic scale</strong> <br /><br />
...
5. <strong>Use the browser default line height of 1.2em</strong> <br /><br />

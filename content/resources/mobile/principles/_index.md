...
As a reminder, we distilled these from [DigitalDashboard.gov](https://www.digitaldashboard.gov/), Google's [Mobile Friendly Test](https://search.google.com/test/mobile-friendly) tool, and the [Information Technology & Innovation Foundation (ITIF) Benchmarking Report](https://itif.org/publications/2017/03/08/benchmarking-us-government-websites). In each, we provide a description of the issue, a method to detect the issue, and solutions to eliminate or prevent the issue from appearing your site to help make it more mobile-friendly. 

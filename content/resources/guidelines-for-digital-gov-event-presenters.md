...
{{< checklist >}}
  ...
  {{< checkbox >}} Optimize images by selecting an image, clicking on {{< highlight >}}Picture Format tab{{< /highlight >}} → {{< highlight >}}Compress Pictures{{< /highlight >}} → {{< highlight >}}On-screen (150 ppi){{< /highlight >}}. Select the option, `All pictures in this file.` {{< /checkbox >}} 

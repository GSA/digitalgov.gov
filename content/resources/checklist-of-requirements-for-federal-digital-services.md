...
<p class="more">
  <a href="{{< ref "/topics/21st-century-idea" >}}">More on 21st Century IDEA
    <svg class="icon__cicle-arrow-forward dg-icon dg-icon--standard margin-bottom-05" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" focusable="false">

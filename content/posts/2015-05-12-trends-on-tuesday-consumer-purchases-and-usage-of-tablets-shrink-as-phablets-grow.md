...
For government agencies, this continues to echo the drum beat that [we need to move swiftly to mobile-friendly sites](({{< relref "trends-on-tuesday-u-s-mobile-only-internet-users-now-outnumber-desktop-only-users.md" >}})) that [offer flexible designs](({{< relref "trends-on-tuesday-smartphone-market-growth-makes-mobile-friendly-a-must.md" >}})) from [small phones to all sizes of tablets and phablets](({{< relref "trends-on-tuesday-responsive-web-design-implementation-happening-piecemeal.md" >}})) to [serve our constituents](({{< relref "trends-on-tuesday-40-of-americans-use-smartphones-to-find-government-information.md" >}})). If you’re preparing to move your digital properties to be mobile-friendly, [check out these resources](({{< relref "helpful-resources-to-help-make-your-content-mobile-friendly.md" >}})).**

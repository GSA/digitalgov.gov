...
That’s the theme from the responses we got from our [Mobile Gov Community of Practice]({{< link href="cagegories/mobile" >}} "Mobile") members when we asked them to predict the effect mobile would have on the Web over the next 25 years.
...
There is a LOT more thinking and doing to be done. Help build toward this anytime, anywhere, anything future by getting involved with the [Mobile Gov Community of Practice]({{< link href="cagegories/mobile" >}} "Mobile") or one of [our other communities]({{< relref "communities.md" >}} "Communities").

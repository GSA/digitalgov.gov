...
_Learn more about_ [_how agencies are using Social Media_]({{< link "cagegories/socialmedia" >}})_, and how to join our various_ [_Communities of Practice_]({{< relref "communities.md" >}})_, like_ [_SocialGov_]({{< relref "social-media.md" >}})_,_ [_Digital Audio/Video Production and Strategy_]({{< relref "digital-audio-video-community-of-practice.md" >}})_, and the_ [_Web Content Managers Forum_]({{< relref "web-managers-forum.md" >}})_._
---
url: 2017/01/19/automatic-https-enforcement-for-new-executive-branch-gov-domains.md
...
This year, GSA will be taking another significant step forward in making secure communication the default for federal web services by automatically enforcing HTTPS in modern web browsers for newly issued executive branch .gov domains and their subdomains. {{< legacy-img src="CDN/files/2017/01/600-x-400-Dot-gov-internet-domain-marekuliasz-iStock-Thinkstock-476434043.jpg" alt=" width=" >}} 
...
_Learn more about [security]({{< link "tag/security" >}}) and [HTTPS]({{< link "tag/https" >}}) — including why [switching to HTTPS will make your analytics better]({{< relref "2016-06-06-why-switching-to-https-will-make-your-analytics-better.md" >}}) and how [HTTPS can impact the SEO of government websites]({{< relref "2015-09-02-https-and-other-ranking-factors-what-impacts-the-seo-of-government-websites.md" >}}). If you have a .gov or .mil email address, consider joining our [communities]({{< relref "communities.md" >}}) to connect with other feds working on web and digital projects._
...
The interactive wall was built after many months of [ideation]({{< relref "challenges.md" >}}), [prototyping]({{< relref "prototype.md" >}}), and [user testing]({{< relref "ux/user-testing-research.md" >}}). At the outset, the team established core objectives, namely:

...
Searchers are on your site to complete a task. Having placeholder text **_inside_** a search box distracts from the task and it reduces the [usability]({{< link "cagegories/ux" >}}) and [accessibility]({{< relref "accessibility.md" >}}) of the search box. Placeholders look simple, but are in fact very tricky to use.

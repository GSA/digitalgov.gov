...
When we developed the first [U.S. Public Participation Playbook](({{< relref "3rd-u-s-public-participation-playbook-draft-released-this-month.md" >}})), and extended an [invitation to the civic coding community](({{< relref "u-s-public-participation-playbook-open-for-coders-and-designers-on-github.md" >}})) to share their contributions.
...
These are just some of the commitments from our team for the third U.S. National Action Plan for Open Government: to learn more, read the announcements [from the White House](({{< relref "gsa-open-government-builds-solutions-and-gives-voice-to-citizens) and from [Data.gov](http://www.data.gov/meta/open-government-national-action-plan.md" >}})).
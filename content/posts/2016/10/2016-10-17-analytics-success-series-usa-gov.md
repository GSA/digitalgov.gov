...
We decided to start with the data! A lot of that data was from the [Digital Analytics Program]({{< link "service_dap.md" >}})’s (DAP) Google Analytics (GA) account &#8212; mainly, how were people using our current versions of the site?

...
_This article is the result of a thread on our User Experience Community listserv. See how other agencies are working with [content]({{< ref "categories/content" >}}) and [video]({{< ref "categories/video" >}}), and find out how to join our [Communities]({{< ref "/communities/_index.md" >}}), like [Digital Audio/Video Production and Strategy]({{< ref "communities/video-production/" >}}) and [User Experience]({{< ref "user-experience.md" >}})._
_If you’re interested in writing for [DigitalGov]({{< ref "index.html" >}}), learn about the [Open Opportunities program]({{< ref "open-opportunities.md" >}}) and check out our assignments (for feds with .gov or .mil email accounts only). If your agency’s team has tech-related lessons learned, case studies, digital or mobile product news, strategy success stories, etc. to share, please [review our guidelines]({{< ref "join.md#guidelines" >}}) and [contact DigitalGov]({{< ref "/about/about.md" >}}) to submit an article idea._

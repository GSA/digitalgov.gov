---
url: 2016/12/01/lessons-learned-evaluating-video-content.md
...
_This article is the result of a thread on our User Experience Community listserv. See how other agencies are working with [content]({{< link "categories/content" >}}) and [video]({{< link "categories/video" >}}), and find out how to join our [Communities]({{< relref "communities.md" >}}), like [Digital Audio/Video Production and Strategy]({{< tmp "communities/digital-audio-video-community-of-practice.md" >}}) and [User Experience]({{< relref "federal-user-experience-community-of-practice.md" >}})._
_If you’re interested in writing for [DigitalGov]({{< link "index.html" >}}), learn about the [Open Opportunities program]({{< relref "open-opportunities-in-digitalgov.md" >}}) and check out our assignments (for feds with .gov or .mil email accounts only). If your agency’s team has tech-related lessons learned, case studies, digital or mobile product news, strategy success stories, etc. to share, please [review our guidelines]({{< relref "join-digitalgov.md" >}}) and [contact DigitalGov]({{< relref "contact-us.md" >}}) to submit an article idea._
...
The interactive wall was built after many months of [ideation]({{< ref "categories/challenges" >}}), [prototyping]({{< ref "tag/prototype" >}}), and [user testing]({{< ref "categories/user-testing-research" >}}). At the outset, the team established core objectives, namely:
...
_Is your agency using innovative technologies to enhance user experience? Let us know in the comments below or [send us an email]({{< ref "/about/about.md" >}})._

...
First, we plunged head-first into an analysis of available analytics via the [Digital Analytics Program]({{< ref "service_dap.md" >}})—beyond the bounce rate. We needed to expose all the issues if we planned to fix them.

---
url: 2016/09/20/analytics-success-series-health-resources-services-administration.md
...
First, we plunged head-first into an analysis of available analytics via the [Digital Analytics Program]({{< relref "dap.md" >}})—beyond the bounce rate. We needed to expose all the issues if we planned to fix them.

...
How are people getting to your site? Use data to support assumptions. This [metrics](({{< ref "categories/metrics" >}})) data should be pulled and evaluated prior to the workshop.

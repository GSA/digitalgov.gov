...
_If you’re interested in learning more about how to connect with Hispanics on social media, follow [#SomosSocial](https://twitter.com/hashtag/somossocial), and check out our other [multilingual articles on DigitalGov]({{< ref "tag/multilingual" >}})._ _If you’re a government employee, consider joining one of our [Communities]({{< ref "/communities/_index.md" >}}), such as the [Multilingual Community of Practice]({{< ref "multilingual.md" >}}), [SocialGov]({{< ref "social-media.md" >}}), and the [Web Content Managers Forum]({{< ref "web-managers-forum.md" >}})._
...
_Read recent posts on_ [_data_]({{< ref "categories/code" >}}data1/)_,_ [_APIs_]({{< ref "categories/api" >}})_, and_ [_open source_]({{< ref "tag/open-source" >}})_, and news about_ [_challenge and prize competitions_]({{< ref "categories/challenges" >}}) _and_ [_crowdsourcing & citizen science_]({{< ref "categories/crowdsourcing-and-citizen-science" >}}) _projects._

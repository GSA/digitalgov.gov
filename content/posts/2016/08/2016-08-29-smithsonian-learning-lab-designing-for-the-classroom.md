...
The extensive [user testing]({{< ref "categories/user-testing-research" >}}) and feedback sessions resulted in key observations and feature requests. One of the biggest eye-openers was that high school teachers saw the Learning Lab as a tool for their students rather than themselves.

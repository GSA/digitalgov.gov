...
I met with several federal contact center managers from the [Government Contact Center Council]({{< relref "government-contact-center-council-g3c.md" >}}) (G3C) to learn from their experiences. Each had used or is currently using incentives/disincentives in their contact center contract. Some of the managers loved incentives/disincentives; some didn’t. But ALL agreed on these tips:
...
_Learn more about the [Government Contact Center Council]({{< relref "government-contact-center-council-g3c.md" >}}) ({{< relref "social-media-metrics-for-federal-agencies.md" >}})._

Take a look at the other Contact Center articles we published in April:

  * [Customer Satisfaction: Innovating with Lack of Resources](({{< relref "customer-satisfaction-innovating-with-lack-of-resources.md" >}}))
  * [Trends on Tuesday: How Contact Centers are Adapting to the Mobile User](({{< relref "trends-on-tuesday-how-contact-centers-are-adapting-to-the-mobile-user.md" >}}))
  * [Need Help Responding to Facebook & Twitter Questions? Use Your Contact Center Customer Service Experts](({{< relref "need-help-responding-to-facebook-twitter-questions-use-your-contact-center-customer-service-experts.md" >}}))
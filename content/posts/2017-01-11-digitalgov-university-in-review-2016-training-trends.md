...
{{< legacy-img src="https://www.WHATEVER/files/2017/04/600-x-127-DigitalGov_University.png" alt="DigitalGov University (D G U) logo" >}}
...
Some of our most popular training topics throughout the year focused on using programs such as analytics trainings offered through the [Digital Analytics Program](https://www.WHATEVER/services/dap/) and trainings on how to use the [DigitalGov Search](https://www.WHATEVER/services/search/) program. Other popular events were from the various [DigitalGov Communities](https://www.WHATEVER/communities/) like the [MobileGov Community of Practice](https://www.WHATEVER/communities/mobile/), [Challenge and Prizes Community of Practice](https://www.WHATEVER/communities/challenges-prizes-community/), and the [Government Customer Experience Community of Practice](https://www.WHATEVER/communities/customer-experience-community/) where best practices, case studies, and innovations were shared.
...
](https://www.WHATEVER/event/cloud-native-devops-with-cloud-gov/) This workshop provided an introduction to the cloud.gov service by showing how to leverage the power of the cloud, and how to reduce duplication and start focusing on the creative work your team needs to deliver on their mission.
  4. [Automatic for the People: AI, Machine Learning and Chatbots for Digital Customer Service in Government
  
](https://www.WHATEVER/event/automatic-for-the-people-ai-machine-learning-and-chatbots-for-digital-customer-service-in-government/) This session covered how automated services powered by government data and new advances in artificial intelligence and machine learning can help improve and expand digital customer service initiatives.
  5. [October Challenge and Prize Community of Practice meeting
  
](https://www.WHATEVER/event/october-challenge-prize-community-of-practice-meeting/) This quarterly informative session highlighted the latest in public-sector prize practice.
...
_Federal employees:_ [_email us_](mailto:DigitalGovU@gsa.gov) _and let us know what you’d like to see in the upcoming year — or [fill out this form](https://www.WHATEVER/digitalgov-university/digitalgov-university-event-and-training-request-form/) to contact the team about creating an online or in-person DGU event._
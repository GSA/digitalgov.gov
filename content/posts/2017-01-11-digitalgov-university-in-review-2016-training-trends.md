...
Some of our most popular training topics throughout the year focused on using programs such as analytics trainings offered through the [Digital Analytics Program]({{< relref "dap.md" >}}) and trainings on how to use the [DigitalGov Search]({{< relref "search.md" >}}) program. Other popular events were from the various [DigitalGov Communities]({{< relref ") like the [MobileGov Community of Practice](https://www.WHATEVER/communities/mobile.md" >}}), [Challenge and Prizes Community of Practice]({{< relref "challenges-prizes-community.md" >}}), and the [Government Customer Experience Community of Practice]({{< relref "customer-experience-community.md" >}}) where best practices, case studies, and innovations were shared.
...
_Federal employees:_ [_email us_]({{< relref "digitalgov-university-event-and-training-request-form.md" >}}) to contact the team about creating an online or in-person DGU event._
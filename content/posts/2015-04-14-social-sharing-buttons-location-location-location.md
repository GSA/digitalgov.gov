...
DigitalGov has seen posts from members of the community who land on opposite sides regarding social sharing buttons. There are those who find social sharing buttons useful (({{< relref "when-sharing-buttons-work.md" >}}))) and those who’ve found the opposite (({{< relref "to-use-social-sharing-buttons-or-not.md" >}}))). I’d argue the utility can be found in adjusting how, or more specifically where, you use them. But first…

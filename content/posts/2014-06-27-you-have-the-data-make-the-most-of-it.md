...
Here are three key steps to help you get started making the most of your data. You can also download and use my [new quarterly report metrics template](({{< relref "creating-awesome-web-analytics-reports-and-presentations.md" >}})), and read up on [Google Analytics for government](({{< relref "new-google-analytics-for-government-training-manual.md" >}})).

...
In our February workshop, we learned members of the [MobileGov Community of Practice]({{< link href="cagegories/mobile" >}}) are using built-in responsive templates in open source content management systems (CMS) in order to better manage existing content and make it user-friendly across a variety of mobile devices.

...
[What does it mean to have a mobile friendly site?](({{< relref "is-your-site-mobile-friendly.md" >}})) Can your visitors access your services and information easily from a mobile phone?

[Less is More](({{< relref "mobile-content-less-is-more.md" >}})). One of the biggest barriers to optimizing a site for mobile is trimming down the large volumes of content and text that many sites host. Large volumes of content not only weigh down a page, but make it harder for readers to take in the information you are trying to communicate.

How does Search Engine Optimization (({{< relref "mobilegeddon-government-edition.md" >}})).

**Resources & Tools**

  * [Join our MobileGov Community]({{< relref "mobile.md" >}})
  * [Mobile Development and Testing with Chrome Developer Tools](({{< relref "mobile-development-and-testing-with-chrome-devtools.md" >}}))
  * [Google Mobile Testing Tool](https://testmysite.thinkwithgoogle.com/)
  * [Four Steps to Achieve Good SEO](({{< relref "four-steps-to-achieve-good-seo.md" >}}))
  * [Search Engine Optimization for Government Websites](({{< relref "search-engine-optimization-for-government-websites.md" >}}))
  * [The Content Corner: The Balance Between SEO and the User](({{< relref "the-content-corner-the-balance-between-seo-and-the-user.md" >}}))
  * [The Content Corner: How Google Judges Your Content](({{< relref "the-content-corner-how-google-judges-your-content.md" >}}))
...
Making the switch to HTTPS can be a difficult change for many websites. But in recent years, over 85% of federal sites [made a change](({{< relref "http-vs-https-is-it-time-for-a-change.md" >}})).

**Resources & Tools**

  * [The HTTPS-Only Standard](https://https.cio.gov/)
  * [HTTPS and Other Ranking Factors: What Impacts the SEO of Government Websites?](({{< relref "https-and-other-ranking-factors-what-impacts-the-seo-of-government-websites.md" >}}))
  * [Why Switching to HTTPS Will Make Your Analytics Better](({{< relref "why-switching-to-https-will-make-your-analytics-better.md" >}}))
  * [Automatic HTTPS Enforcement for New Executive Branch .Gov Domains](({{< relref "automatic-https-enforcement-for-new-executive-branch-gov-domains.md" >}}))
...
**Resources & Tools**
  ...
  * [Join our User Experience ({{< relref "federal-user-experience-community-of-practice.md" >}})
  * [Accessibility Resource List](({{< relref "using-section-508-guidance-to-improve-the-accessibility-of-government-services.md" >}}))
  ...
  * [Celebrating the 18th Anniversary of the Section 508 Rehabilitation Act](({{< relref "celebrating-the-18th-anniversary-of-section-508-rehabilitation-act.md" >}}))
...
_Federal agencies can register their mobile products—mobile websites and native apps—on the_ [_U.S. Digital Registry_]({{< relref "u-s-digital-registry.md" >}})_._ 

...
_If you are not a current DAP user, you can [learn more about DAP on DigitalGov.gov]({{< relref "dap.md" >}}). You can also read [articles]({{< relref "metrics.md" >}}) and attend [free training on analytics, metrics and other digital government subjects]({{< link "events" >}})._

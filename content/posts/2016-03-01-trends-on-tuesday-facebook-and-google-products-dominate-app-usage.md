...
Government agencies should consider this when debating a responsive Web vs app strategy, and  [follow DigitalGov for more mobile trends and information]({{< relref "mobile.md" >}})—as well as join the new [MobileGov Community of Practice Listserv]({{< relref "mobile.md" >}}), which had a very lively debate this past week over native app vs. responsive Web strategy.
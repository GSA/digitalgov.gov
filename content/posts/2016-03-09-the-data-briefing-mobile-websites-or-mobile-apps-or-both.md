...
Let us start with mobile websites. Mobile websites are essentially the same website you would see on a desktop. Mobile websites are built using HyperText Markup Language version 5 (({{< relref "wherever-you-go-there-we-are-the-geolocation-api.md" >}})) or when the mobile device is moving.

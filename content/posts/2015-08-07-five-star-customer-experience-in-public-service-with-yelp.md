...
The [Yelp amended terms of service](({{< relref "new-nhtsa-app-uses-yelp-api.md" >}})) for the [SaferRide mobile app](({{< relref "saferride-app-could-save-your-life.md" >}})). The SaferRide app included user reviews of transportation services to [give holiday revelers an easy way to find a ride home](({{< relref "saferride-app-could-save-your-life.md" >}})) when they’ve had too much to drink instead of getting behind the wheel.

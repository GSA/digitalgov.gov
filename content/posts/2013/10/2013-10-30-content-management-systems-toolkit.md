...
If you’re making any design changes along with your content migration, do [user testing]({{< ref "/topics/user-testing-research" >}}) early-on, to gather feedback and make improvements before launch.

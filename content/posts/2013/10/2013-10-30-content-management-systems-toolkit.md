...
Before implementing a CMS, you should get rid of “ROT” (Redundant, Outdated, Trivial) content. Your completed content inventory can help you spot the ROT.
  ...
  * [Examine your metrics](({{< ref "categories/metrics" >}})). Do you have pages that are only getting a few visits a month? Those pages may not be worth keeping, if no one is looking at them.
...
[Metadata](http://en.wikipedia.org/wiki/Metadata) is essentially “data about data,” and consists of machine-readable descriptions that tell other computers important facts about your digital content. It provides a standardized system to label and classify content. It also:
  ...
  * Enables content aggregation, re-use, and syndication via Really Simple Syndication (RSS), [Application Programming Interfaces (APIs)]({{< ref "categories/api" >}}), and other technologies
...
If you’re making any design changes along with your content migration, do [user testing]({{< ref "categories/user-testing-research" >}}) early-on, to gather feedback and make improvements before launch.

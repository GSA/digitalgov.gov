...
QR codes are used to bridge the offline and online world. Examples:
  ...
  * GSA&#8217;s [Federal Acquisition Service used QR codes]({{< link "2013-03-07-gsa-fas-qr-code.md" >}} "GSA FAS QR Code") at an expo to help attendees track booths that they visited..
...
**QR code generators** (with [federal compatible terms of service]({{< link "negotiated-terms-of-service-agreements.md" >}}))

...
[{{< legacy-img src="2013/12/USAgovAppsgalleryQRcode.png" alt="An example of a QR code that links to the government app gallery at usa.gov." >}}](https://s3.amazonaws.com/sitesusa/wp-content/uploads/sites/212/2013/12/USAgovAppsgalleryQRcode.png)
...
QR codes are used to bridge the offline and online world. Examples:
  ...
  * GSA&#8217;s [Federal Acquisition Service used QR codes]({{< relref "2013-03-07-gsa-fas-qr-code.md" >}} "GSA FAS QR Code") at an expo to help attendees track booths that they visited..
...
**QR code generators** (with [federal compatible terms of service]({{< relref "negotiated-terms-of-service-agreements.md" >}}))

...
Like the [Android version]({{< link "2012-04-26-noaas-release-mako-app.md" >}} "NOAA’s Release Mako App"), it uses GPS and allows fisherman to upload photographs of their catches. NOAA says:
...
Check out how NOAA [conceptualized this app]({{< link "2012-04-26-noaas-release-mako-app.md" >}} "NOAA’s Release Mako App"). You can find more government mobile products like the [Release Mako](http://apps.usa.gov/release-mako.shtml) App on the [USA.gov Apps Gallery](http://apps.usa.gov/).
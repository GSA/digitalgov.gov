...
{{< legacy-img src="CDN/files/2017/04/600-x-461-Boutet\_1708\_color_circles.jpg" alt="Claude Boutet’s 7-color and 12-color color wheels." >}}
...
{{< legacy-img src="CDN/files/2015/09/600-x-315-US-Web-Design-Standards-desktop-tablet-and-phone-home.jpg" alt="The U.S. Web Design Standards are designed to be viewed on any device." >}}

Another approach to color selection is to utilize the guidance of the [U.S. Web Design Standards](https://standards.usa.gov), created by [18F](https://18f.gsa.gov) and the [U.S. Digital Service](https://www.usds.gov). You may find the [Color Palette](https://standards.usa.gov/components/colors/#palette) section to be of great help — for more information, [watch DGU’s U.S. Web Design Standards Update webinar](https://standards.usa.gov/components/colors/#palette) that was held on January 25th. (Short on time? [Read the highlights recap]({{< relref "2017-02-09-webinar-recap-better-faster-and-more-flexible-u-s-web-design-standards-update.md" >}}).

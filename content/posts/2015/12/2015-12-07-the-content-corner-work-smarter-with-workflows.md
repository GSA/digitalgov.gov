...
As an example, here is my normal workflow that I follow in order to bring you a sensational [Content Corner]({{< ref "tag/the-content-corner" >}}) blog post every Monday.

  1. Review topics added to my [editorial calendar]({{< ref "2015-07-27-the-content-corner-supporting-your-content.md" >}}).
  2. Review DigitalGov’s [monthly theme]({{< ref "categories/monthly-theme" >}}).

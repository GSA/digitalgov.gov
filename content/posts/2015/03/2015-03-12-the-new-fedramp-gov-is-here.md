---
url: 2015/03/12/the-new-fedramp-gov-is-here.md
...
The new FedRAMP.gov worked with each of the following services without incurring any costs to the program:
  ...
  * Analytics: FedRAMP.gov is monitored by the [Digital Analytics Program]({{< relref "dap.md" >}}) (DAP) giving insight to performanceand user experience on the website.

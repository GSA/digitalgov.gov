...
The new FedRAMP.gov worked with each of the following services without incurring any costs to the program:
  ...
  * User Experience Program: FedRAMP used the DigitalGov [User Experience Program]({{< link "/resources/user-experience/" >}}) (formerly First Fridays) to better understand what the needs of our stakeholders are, what they needed from the website, and how to ensure our users have a successful experience on FedRAMP.gov.
  ...
  * Analytics: FedRAMP.gov is monitored by the [Digital Analytics Program]({{< link "dap.md" >}}) (DAP) giving insight to performanceand user experience on the website.

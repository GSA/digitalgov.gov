...
As I mentioned in a recent [blog post about image search]({{< relref "2014-10-28-a-picture-is-worth-a-thousand-tokens" >}}), we&#8217;re avid users of [Elasticsearch](http://www.elasticsearch.org) for search. We also recently ported another vital part of our system to Elasticsearch: analytics.

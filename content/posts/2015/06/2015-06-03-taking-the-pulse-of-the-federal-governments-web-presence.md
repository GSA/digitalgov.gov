...
To participate, agencies place some JavaScript on their websites that report to a combined analytics account. DAP has [privacy controls]({{< link "common-questions-about-dap.md" >}}) that anonymize visitor addresses and restrict data sharing.

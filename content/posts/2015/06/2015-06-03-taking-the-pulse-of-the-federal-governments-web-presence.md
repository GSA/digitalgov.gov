...
[Pulse](https://pulse.cio.gov/) is a lightweight dashboard that uses the [official .gov domain list](https://github.com/GSA/data/blob/gh-pages/dotgov-domains/2015-03-15-federal.csv) to measure two things:
  ...
  * [Analytics](https://pulse.cio.gov/analytics/domains/): Whether federal executive branch domains are participating in the [Digital Analytics Program]({{< ref "/guide/dap/_index.md" >}}) (DAP) that powers [analytics.usa.gov](https://analytics.usa.gov/).
...
The [Digital Analytics Program]({{< ref "/guide/dap/_index.md" >}}) (DAP) is a free, shared Web analytics service for U.S. federal agencies.

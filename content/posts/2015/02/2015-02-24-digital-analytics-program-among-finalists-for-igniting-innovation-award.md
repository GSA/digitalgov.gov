...
_If you are not a current DAP user, you can [learn more about DAP on DigitalGov.gov]({{< ref "service_dap.md" >}}). You can also read [articles](({{< ref "categories/metrics" >}})) and attend [free training on analytics, metrics and other digital government subjects]({{< ref "events" >}})._

...
SMS messages have been used primarily as [marketing tools]({{< link "2013-07-23-trends-on-tuesday-uprise-of-sms-marketing.md" >}}). But, the time has come for the use of SMS messaging to deliver information that customers need and want on a just in time basis. [Text4Baby]({{< link "2012-08-21-sms-or-short-message-service.md" >}}), a program designed to provide health information to new mothers, is just one of a number of [SMS campaigns]({{< link "2012-05-12-national-contact-centers-text-message-program.md" >}}) in the federal government.

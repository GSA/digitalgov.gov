---
slug: gov-analytics-breakdown-2-mobile-is-bigger-than-ever.md
...
_To learn more about the <a href="{{< link "dap.md" >}}" target="_blank">Digital Analytics Program</a>, request access to the data (federal employees only) or to learn how to participate, <a href="mailto:dap@support.digitalgov.gov" target="_blank">email DAP support</a>._
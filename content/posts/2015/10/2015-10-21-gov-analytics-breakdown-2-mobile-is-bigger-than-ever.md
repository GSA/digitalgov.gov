...
_To learn more about the <a href="{{< link "dap.md" >}}" target="_blank">Digital Analytics Program</a>, request access to the data (federal employees only) or to learn how to participate, <a href="mailto:dap@support.WHATEVER" target="_blank">email DAP support</a>._
...
Data quality doesn’t stop with DAP Experts. Every government user of DAP data also has responsibilities, abiding by a [set of rules]({{< ref "common-questions-about-dap-faq.md#part-7.md" >}}) to protect the integrity of the data upon receiving access to it.

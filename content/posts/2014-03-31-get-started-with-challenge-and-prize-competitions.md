...
<p dir="ltr">
  2) <a title="link to Challenges page on DigitalGov.gov" href="{{< link href="categories/challenges" >}}">DigitalGov.gov</a>. Step-by-step toolkits on how to run many types of challenges:
</p>
...
<p dir="ltr">
  3) Digital Gov University. A robust resource of <a href="{{< relref "video-library.md" >}}">archived training</a> and <a title="link to upcoming DigitalGov University training" href="{{< link href="events" >}}">upcoming events</a>. Some of the most popular webinars are:
</p>

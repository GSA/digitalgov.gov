...
The data above show that the [App vs. mobile web debate will continue]({{< relref "mobile-application-development-program.md" >}}) can leverage this trend. If your agency already has an app({{< relref "the-federal-mobile-apps-registry.md" >}}). For more ideas, check out the resources available on DigitalGov.
...
Go.USA.gov is a [URL shortener for government employees]({{< link "service_usagov-short-urls.md" >}}) and only shortens government URLs. Haven&#8217;t signed up? Visit Go.USA.gov to [sign up](https://go.usa.gov/) now.
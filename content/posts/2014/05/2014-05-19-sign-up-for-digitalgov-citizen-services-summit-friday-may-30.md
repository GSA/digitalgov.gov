...
These panels will explore how agencies can integrate their [data]({{< ref "categories/code" >}}data1/), [social media]({{< ref "categories/socialmedia" >}}), [user experience]({{< ref "categories/ux" >}}), [mobile development]({{< ref "categories/mobile" >}}) and other programs in order to achieve the best improvements for citizen services. Confirmed speakers include:

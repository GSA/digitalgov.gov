---
url: 2014/09/05/getting-it-done-with-open-opportunities-the-case-of-the-mobile-code-catalog.md
...
Pretty neat idea, huh? Well last year it [became a reality]({{< relref "2013-05-13-federal-mobile-code-sharing-catalog-is-here.md" >}} "Federal Mobile Code Sharing Catalog Is Here") with the Mobile Code Catalog.
...
He championed, and ultimately volunteered, to lead the development of a [catalog of open source mobile app code]({{< relref "2013-05-13-federal-mobile-code-sharing-catalog-is-here.md" >}} "Federal Mobile Code Sharing Catalog Is Here") for government developers through the auspices of the [Open Opportunities](https://openopps.WHATEVER/) program, a task-based network that leverages government innovators to help agencies deliver government information and services.
...
To learn more about the Open Opportunities program be sure to read our previous post [Hacking the Bureaucracy One Task at a Time]({{< relref "2014-06-23-hacking-the-bureaucracy-one-task-at-a-time.md" >}} "Hacking the Bureaucracy One Task at a Time").

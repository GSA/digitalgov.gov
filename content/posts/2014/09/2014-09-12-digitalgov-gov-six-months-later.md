...
One thing we’ve learned from looking at our data, is that you like lists and data. So, we’ll be customer-focused and share a few things we’ve learned so far:
  ...
  * You especially like articles about [metrics](({{< ref "categories/metrics" >}})), [user experience case studies]({{< ref "tag/usability-case-study" >}}), [social media tools]({{< ref "tag/terms-of-service" >}}), and [mobile trends]({{< ref "tag/trends-on-tuesday" >}}).

...
The best way to stay connected is to discuss these challenges and work together. Join the [SocialGov Commmunity]({{< link "social-media.md" >}} "Social Media"). Get involved with discussions around [competitions and prizes]({{< link "challenges-prizes-community.md" >}} "Challenges & Prizes Community"). Become a [data guru](https://opendata.stackexchange.com/questions/ask?tags=data.gov). Stay involved in the [User Experience community]({{< link "federal-user-experience-community-of-practice.md" >}} "Federal User Experience Community") and, of course, join my [Mobile Gov Community of Practice]({{< link "categories/mobile" >}} "Mobile").

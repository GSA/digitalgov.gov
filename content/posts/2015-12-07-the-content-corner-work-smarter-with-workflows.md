...
As an example, here is my normal workflow that I follow in order to bring you a sensational [Content Corner]({{ "tag/the-content-corner" | absURL }}) blog post every Monday.

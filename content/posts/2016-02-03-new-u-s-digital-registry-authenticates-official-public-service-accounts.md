...
Here’s how it works:
  ...
  1. Government agencies, including members of the collaborative inter-agency [SocialGov]({{< relref "social-media.md" >}}) and [MobileGov]({{< link "cagegories/mobile" >}}) communities, use [OMB Max](https://max.omb.gov/maxportal/home.do) to authenticate users of the U.S. Digital Registry and add their official accounts by:

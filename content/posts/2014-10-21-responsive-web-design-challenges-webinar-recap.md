...
_If you&#8217;re interested in helping solve government challenges around Responsive Web Design, join the [MobileGov Community of Practice]({{< link "cagegories/mobile" >}} "Mobile") and participate in [October&#8217;s MobileGov Around the Horn Call]({{< relref "october-mobile-gov-around-the-horn-call.md" >}} "October Mobile Gov Around the Horn Call") where we will discuss responsive Web design performance._
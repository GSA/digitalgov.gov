...
To create Linda’s behavior line, we looked at:
  ...
  * [Contact center]({{< relref "government-contact-centers.md" >}}) content usage
...
Some specific priorities in our CX improvement queue:
  ...
  * Improve customer understanding by using [personas](({{< relref "personas-101.md" >}})) and journey maps as a standard process that we incorporate into the beginning of any new project or product

...
Agency mobile products registered here are also eligible to be featured in an article in the [DigitalGov.gov mobile channel]({{< relref "mobile.md" >}}). Every Thursday on DigitalGov we [feature a mobile website or native app]({{< relref "thursday-mobile-products.md" >}}) produced by a federal agency that is available on the Federal Mobile Apps Directory.

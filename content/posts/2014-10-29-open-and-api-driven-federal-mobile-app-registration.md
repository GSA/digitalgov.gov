...
Agency mobile products registered here are also eligible to be featured in an article in the [DigitalGov.gov mobile channel](https://www.WHATEVER/category/mobile/). Every Thursday on DigitalGov we [feature a mobile website or native app]({{ "tag/thursday-mobile-products" | absURL }}) produced by a federal agency that is available on the Federal Mobile Apps Directory.

...
Mobile-friendliness is a [must for government](({{< relref "trends-on-tuesday-smartphone-market-growth-makes-mobile-friendly-a-must.md" >}})). But mobilizing the whole digital enchilada takes time due to various challenges, as experiences from the [Department of Education](({{< relref "building-brick-by-brick-ed-govs-website-redesign-and-mobile-implementation.md" >}})) and [National Park Service](({{< relref "mobile-friendly-park-websites-on-nps-gov.md" >}})) have illustrated.

Many agencies are thinking [big things for 2015](({{< relref "how-government-will-accelerate-anytime-anywhere-services-and-information-in-2015.md" >}})), but if your agency is struggling with that first mobile implementation, you will be asking yourself [where to start](({{< relref "how-government-will-accelerate-anytime-anywhere-services-and-information-in-2015.md" >}})). Think mobile moments!
...
Once you find a mobile moment, you should build for mobile and not adapt existing processes. You should [think like a mobile designer](({{< relref "how-to-make-a-mobile-paper-prototype.md" >}})) and the [Department of Veterans Affairs](({{< relref "paper-prototyping-ptsd-coach.md" >}})) both [paper prototyped](({{< relref "design-sketching-the-easiest-prototype-method-ever.md" >}})) for their mobile users. There are also [digital tools](https://popapp.in/en/terms/government-users) that allow you to prototype for mobile.
...
There are many examples of agencies who are winning their mobile moments. See [IRS2Go](({{< relref "irs2go-app-provides-multi-symptom-relief-for-tax-anxiety.md" >}})), [NOAA’s Dolphin and Whale 911](({{< relref "saving-the-whales-with-just-your-smartphone-west-coast-edition.md" >}})), and [OSHA’s Heat Safety App](({{< relref "osha-heat-safety-tool-app.md" >}})). However, the TSA is winning big.

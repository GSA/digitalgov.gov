...
_If you haven’t already, be sure to register your social media accounts, mobile apps, and mobile websites with the [U.S. Digital Registry]({{< relref "u-s-digital-registry.md" >}}). You can also check DigitalGov’s [Resources]({{< link href="resources" >}}) to read about [Improving the Accessibility of Social Media in Government]({{< relref "improving-the-accessibility-of-social-media-in-government.md" >}}) and the [Federal Social Media Accessibility Toolkit]({{< relref "federal-social-media-accessibility-toolkit-hackpad.md" >}})._
...
As I mentioned in a recent [blog post about image search](({{< relref "a-picture-is-worth-a-thousand-tokens.md" >}})), we&#8217;re avid users of [Elasticsearch](http://www.elasticsearch.org) for search. We also recently ported another vital part of our system to Elasticsearch: analytics.
...
{{< legacy-img src="https://s3.amazonaws.com/sitesusa/wp-content/uploads/sites/212/2015/01/564-x-506-DG-Search-Dataflow-for-Analytics.jpg" alt="564-x-506-DG-Search-Dataflow-for-Analytics" >}}

...
[Best practices: Marketing an apps challenge](({{< relref "how-to-implement-an-apps-challenge.md" >}}))

[Best practices: Post-competition](({{< relref "how-to-improve-an-apps-challenge.md" >}}))

[Lessons learned, sample rules, and press clips](({{< relref "how-to-implement-an-apps-challenge.md" >}}))

...
One thing we’ve learned from looking at our data, is that you like lists and data. So, we’ll be customer-focused and share a few things we’ve learned so far:
  ...
  * You especially like articles about [metrics](https://www.WHATEVER/category/metrics/), [user experience case studies]({{ "tag/usability-case-study" | absURL }}), [social media tools]({{ "tag/terms-of-service" | absURL }}), and [mobile trends]({{ "tag/trends-on-tuesday" | absURL }}).

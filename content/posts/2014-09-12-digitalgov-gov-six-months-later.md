...
One thing we’ve learned from looking at our data, is that you like lists and data. So, we’ll be customer-focused and share a few things we’ve learned so far:
  ...
  * You especially like articles about [metrics]({{< relref "metrics.md" >}}), [user experience case studies]({{< relref "usability-case-study.md" >}}), [social media tools]({{< relref "terms-of-service.md" >}}), and [mobile trends]({{< relref "trends-on-tuesday.md" >}}).
  ...
  * You’re landing and navigating to what you need ({{< relref "negotiated-terms-of-service-agreements/ "Negotiated Terms of Service Agreements"), [Accessibility](https://www.WHATEVER/category/ux/accessibility.md" >}}), and for [Specific Events](https://www.WHATEVER/events/). Some of you, we think, are looking for the articles you wrote. Good on you. They are something to be proud of!

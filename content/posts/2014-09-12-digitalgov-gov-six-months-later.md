...
One thing we’ve learned from looking at our data, is that you like lists and data. So, we’ll be customer-focused and share a few things we’ve learned so far:
  ...
  * You especially like articles about [metrics](({{< link href="categories/metrics" >}})), [user experience case studies]({{< link href="tag/usability-case-study" >}}), [social media tools]({{< link href="tag/terms-of-service" >}}), and [mobile trends]({{< link href="tag/trends-on-tuesday" >}}).

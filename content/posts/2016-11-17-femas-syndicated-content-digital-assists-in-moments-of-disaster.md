...
The [FEMA widgets](({{< relref "the-content-corner-structured-content-and-the-power-of-syndication.md" >}})). Through digital media [syndication](({{< relref "does-content-syndication-work.md" >}})), emergency based resources can be combined with ongoing activities at the state and local levels, and can help coordinate emergency messaging for maximum impact and reach.

...
An organization can’t have [content strategy]({{< relref "content-strategy.md" >}}) and [structured content]({{< relref "open-and-structured-content-models.md" >}}) until it learns to operate in a structured way.
...
One solution to fix these problems is to get people thinking about content strategy—and patience is key to that success. There are many [techniques](({{< relref "content-models-as-simple-as-pizza-pie.md" >}})) to get [content models](({{< relref "how-to-create-portable-content-with-structured-content-models.md" >}})) created, but changing way people think may take a while.

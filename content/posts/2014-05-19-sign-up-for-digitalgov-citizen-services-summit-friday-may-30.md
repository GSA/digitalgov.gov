...
These panels will explore how agencies can integrate their [data]({{< link href="categories/code" >}}data1/), [social media]({{< link href="categories/socialmedia" >}}), [user experience]({{< link href="categories/ux" >}}), [mobile development]({{< link href="categories/mobile" >}}) and other programs in order to achieve the best improvements for citizen services. Confirmed speakers include:

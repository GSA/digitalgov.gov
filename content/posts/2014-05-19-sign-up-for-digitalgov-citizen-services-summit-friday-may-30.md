...
We won’t build the government of the 21st century by [drawing within the lines](({{< relref "because-its-hard.md" >}})).
...
To get ourselves thinking outside the lines in order to build an awesome 21st century government we’re bringing federal, industry and state and local employees together for the [DigitalGov Citizen Services Summit]({{< relref "digitalgov-citizen-services-summit.md" >}}) on Friday, May 30.
...
These panels will explore how agencies can integrate their [data]({{< relref "code/data1.md" >}}), [social media]({{< relref "socialmedia.md" >}}), [user experience]({{< relref "ux.md" >}}), [mobile development]({{< relref "mobile.md" >}}) and other programs in order to achieve the best improvements for citizen services. Confirmed speakers include:
...
[Register Now]({{< relref "digitalgov-citizen-services-summit.md" >}})! Seats are Limited!
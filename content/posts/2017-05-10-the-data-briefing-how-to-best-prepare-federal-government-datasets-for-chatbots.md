...
Along with [mobile apps]({{< relref "2016-01-27-the-data-briefing-improving-the-federal-government-through-mobile-apps.md" >}}), there are [responsive websites]({{< link href="tag/responsive-web-design" >}}) and [progressive web apps]({{< relref "2016-09-20-progressive-web-applications-part-1-the-new-pack-mule-of-the-internet.md" >}}). These information sources are optimized for mobile devices. The apps are responsive and easy-to-use but, they merely deliver information as any website does. What users are now demanding is a more personal experience when interacting with data.

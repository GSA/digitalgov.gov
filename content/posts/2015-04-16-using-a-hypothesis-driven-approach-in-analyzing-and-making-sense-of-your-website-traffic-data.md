...
At the [Digital Analytics Program](({{< relref "digital-analytics-program-dap-oceans-of-data.md" >}})), how do we not “drown” in it, and, perhaps more importantly, how do we make sense of it?
...
To see if we’d reach that new record of real-time traffic in DAP on #TaxDay, our DigitalGov team performed [live blogging and hourly monitoring throughout the day yesterday](({{< relref "live-blogging-the-analytics-dashboard-on-tax-day/ "Updated: Live Blogging the Analytics Dashboard on #TaxDay") to report on the real-time users on the .gov websites as part of the [public dashboard](https://analytics.usa.gov.md" >}})). And…. the hypothesis did not hold true (and was rejected by reality). The highest number of real-time visitors gov-wide we got on #TaxDay for 2015 was just shy of 200K.

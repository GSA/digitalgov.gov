...
People have worked on big tasks like developing a [mobile code sharing catalog]({{< relref "2013-05-13-federal-mobile-code-sharing-catalog-is-here.md" >}}, leading a project to [create content models]({{< relref "2014-05-05-government-open-and-structured-content-models-are-here.md" >}}, and [tracking mobile trends and writing blog posts]({{ "tag/trends-on-tuesday" | absURL }}). Some have worked on smaller tasks like helping clean up data to improve search results, designing badges, video captioning and copy editing.

...
One is hosted on HowTo.gov for people who work for the federal government to [register their accounts]({{< link "service_us-digital-registry.md" >}}). Anyone with a .gov or .mil email address can fill out a form, and receive an email with a link to another form where they can register their official accounts simply by pasting in the URL of the account. For each account they add, they have to include their agency and the language of the account.
...
## Resources
  ...
  * [Register your federal government social media account in the Social Media Registry]({{< link "service_us-digital-registry.md" >}})

...
<a href="{{< relref "2012-11-19-case-study-how-dol-created-software-development-kits-sdks.md" >}}" rel="attachment wp-att-103422">{{< legacy-img src="2014/01/apis-user-cost-whole-dataset-apps-250x187.png" alt="apis-user-cost-whole-dataset-apps" >}}</a>

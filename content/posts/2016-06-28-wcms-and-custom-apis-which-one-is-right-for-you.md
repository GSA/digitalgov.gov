...
****[Gray Brooks]({{< relref "gray-brooks.md" >}}) of GSA gave us a great definition of APIs in the [DigitalGov University (DGU)]({{< relref "digitalgov-university.md" >}}) presentation, [Introduction to APIs]({{< relref "2012-07-26-introduction-to-apis.md" >}}.

...
[Metadata](http://en.wikipedia.org/wiki/Metadata) is essentially “data about data,” and consists of machine-readable descriptions that tell other computers important facts about your digital content. It provides a standardized system to label and classify content. It also:
  ...
  * Enables content aggregation, re-use, and syndication via Really Simple Syndication ({{< relref "code/api.md" >}}), and other technologies
...
If you’re making any design changes along with your content migration, do [user testing]({{< relref "ux/user-testing-research.md" >}}) early-on, to gather feedback and make improvements before launch.

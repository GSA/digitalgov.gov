...
What does this mean for federal agencies? The time to move forward with mobile strategies that involve users with social media has arrived, and the [Mobile Gov]({{< link "cagegories/mobile" >}} "Mobile") and [Social Media]({{< relref "social-media.md" >}} "Social Media") Communities of Practice are here to help!

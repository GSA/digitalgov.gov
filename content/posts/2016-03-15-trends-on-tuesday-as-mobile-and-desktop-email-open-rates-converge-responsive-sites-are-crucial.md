...
As people become [more mobile-first and mobile-only users of the Internet](({{< relref "trends-on-tuesday-mobile-only-u-s-audiences-grow-while-broadband-usage-drops.md" >}})), users opening emails on their desktop devices has dropped continuously for the past 2 years, from 22.6% to 15.3%.
...
Making sure your email newsletters, as well as, links from your email newsletters are responsive-optimized is critical for reaching agency audiences who increasingly are [using their smartphones for most tasks](({{< relref "trends-on-tuesday-more-time-consuming-complex-tasks-on-mobile-platforms.md" >}})).
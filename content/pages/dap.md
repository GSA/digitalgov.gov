...
The program consists of:
  ...
  * A public window into some DAP data at [analytics.usa.gov](https://analytics.usa.gov) 
      * Want to fork our dashboard? See our [GithubÂ repo](https://github.com/18F/analytics.usa.gov)
...
### No-cost, hosted website analytics
  ...
  * Meets agency compliance with OMB reporting on theÂ 10 Minimum Common Baseline Performance Metrics for [Milestone 8.2](https://www.digitalgov.gov/files/2012/10/8_2_DGS_Implementation_Instructions_v_final.docx).
...
Any federal agency can sign up to use the common Web analytics tool. Here&#8217;s how it works:
  ...
  * If you don&#8217;t have an identified POC,Â [send us an email](mailto:dap@support.digitalgov.gov).
...
You canÂ [view the most common questions about the program](https://www.digitalgov.gov/services/dap/common-questions-about-dap-faq/ "Common Questions about DAP (FAQ)")Â and [learn more aboutÂ incorporating the Digital Analytics Tool into your current metrics program](https://www.digitalgov.gov/services/dap/incorporating-the-digital-analytics-program-tool-into-your-agencys-metric-program/ "Incorporating the Digital Analytics Program Tool Into Your Agencyâ€™s Metric Program").

### Contact Us

Email theÂ [Digital Analytics Program](mailto:dap@support.digitalgov.gov)
...
title: Part 2 Delivering on 21st Century IDEA A case study from the GSA SmartPay team
summary: A GSA SmartPay product owner shares his experiences as a first-time
  product owner in a government agile development project.
...
{{< box color="" >}} “It was like trying to keep 100 balloons that were dropped from the ceiling at different times from touching the floor.” {{< /box >}}
...
{{< box color="base" >}} “Section 508 is a law, but accessibility is an experience, and our website delivers well beyond Section 508.” {{< /box >}}
...
{{< box color="base-light" >}} “It might be uncomfortable but as long as the process is done right, it will pay off.” {{< /box >}}
...
{{< box color="base-dark" >}} “Don’t forget to eat lunch!” {{< /box >}}

...
One thing we’ve learned from looking at our data, is that you like lists and data. So, we’ll be customer-focused and share a few things we’ve learned so far:
  ...
  * You especially like articles about [metrics]({{< ref "/topics/analytics" >}}), [user experience case studies]({{< ref "/topics/usability-case-study" >}}), [social media tools]({{< ref "/topics/terms-of-service" >}}), and [mobile trends]({{< ref "/topics/trends-on-tuesday" >}}).

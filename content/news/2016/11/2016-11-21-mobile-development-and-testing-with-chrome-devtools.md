...
_Federal agencies can register their mobile products—mobile websites and native apps—on the [U.S. Digital Registry](https://digital.gov/services/u-s-digital-registry/) to verify that they’re [mobile-friendly]({{< ref "2015-10-23-is-your-site-mobile-friendly.md" >}}), authoritative sources of government information. [Learn more](https://digital.gov/topics/social-media/) about the Registry and [sign up here](https://touchpoints.app.cloud.gov/registry)._

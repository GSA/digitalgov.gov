...
The interactive wall was built after many months of [ideation]({{< ref "/topics/challenges" >}}), [prototyping]({{< ref "/topics/design" >}}), and [user testing]({{< ref "/topics/user-research" >}}). At the outset, the team established core objectives, namely:

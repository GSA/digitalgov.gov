...
summary: GSA has developed a composite indicator to visualize six key components
  of website success.
...
IMAGE filename: visits30days.png\
ALT: A bar chart of the average number of website visits across GSA over the past 30 days. Three bars are placed horizontally along an axis. The topmost bar indicates that the top 10 sites in GSA had an average of 626,926 visits in the past 30 days. The middle bar shows the agency average is 244,334 website visits over the same time period. The bottom bar shows the average visits to the bottom 10 websites is 66 visits per month.
...
IMAGE filename: 508issues.png\
ALT: A bar chart showing the top 5 websites with the most accessibility issues. The vertical axis shows the number of issues. The horizontal axis shows a bar for each of the 5 websites. The bars show that Website 1 has 10,000 accessibility issues, Website 2 has 1,203 issues, Website 3 has 460 issues, Website 4 has 172 issues, and Website 5 has 94 issues.
...
IMAGE filename: websiteperformance.png\
ALT: A bar chart showing website performance measured by a free online tool. The vertical axis is labeled Website Performance. The horizontal axis has three bars. The first bar shows an average of the top 10 sites; they measure 100%, a perfect score. The middle bar shows average agency website performance is 84%, which is good, but there’s room for improvement. The third bar is average of the bottom 10 sites, and measures 26%, which is considered a poor score.
...
IMAGE filename: piechart1.png; piechart2.png

Caption: Website A ; Website B

ALT piechart1: A circular chart divided in 6 wedges centered on a gray circle. The wedges fill the circle except 1; the website almost completely meets standards. 

ALT piechart1: A circular chart divided in 6 wedges centered on a gray circle. None of the wedges fills the gray circle, meaning the website does not meet standards.

In addition, these charts, like all maps, contains some decisions that prioritize how the information is rendered. They include: 

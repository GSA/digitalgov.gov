...
summary: 'How to incorporate the DAP’s JavaScript code for website analytics.'
authors:
  - lisa-bari
topics:
  - metrics
...
The [Digital Analytics Program]({{< ref "/guides/dap/_index.md" >}}) (DAP) offers no cost, hosted web analytics to federal agencies. 

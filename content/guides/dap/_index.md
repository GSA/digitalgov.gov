...
title: "An introduction to the Digital Analytics Program (DAP)"
...
- [Get started with DAP: Use DAP to better understand user behavior](#)
- [Make data-informed decisions: How to turn the DAP data into actionable insights](#)
- [Glossary of terms: Browse DAP terms](#)
- [Migration: Learn about the migration from Universal Analytics to Google Analytics 4](#)
- [Terms of service: GSA offers DAP subject to your acceptance of these terms](#)

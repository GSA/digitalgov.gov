...
{{< note >}}These instructions reference a sample Listserv called _TESTLIST@listserv.gsa.gov_. Just replace _TESTLIST_ in the command line examples above with the name of YOUR Listserv to apply them to your Listserv. For example, use _set CONTENT-MANAGERS-L digest_ to receive a daily digest of plain text posts from the Web Managers Listserv.{{< /note >}}

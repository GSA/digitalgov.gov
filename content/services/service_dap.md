...
The program consists of:
  ...
  * Training
      ...
      * Future training found on our [events page]({{< ref "/events" >}})
  * Implementation support
      * [DAP FAQs]({{< ref "common-questions-about-dap-faq.md" >}})
      * [Implementation instructions]({{< ref "analytics-tool-instructions.md" >}})
  ...
  * [Digital Metrics guidance and best practices]({{< ref "dap-digital-metrics-guidance-and-best-practices.md" >}} "DAP: Digital Metrics Guidance and Best Practices")
...
### No-cost, hosted website analytics
  ...
  * Meets agency compliance with OMB reporting on the 10 Minimum Common Baseline Performance Metrics for [Milestone 8.2](https://s3.amazonaws.com/digitalgov/_legacy-img/2012/10/8_2_DGS_Implementation_Instructions_v_final.docx).
...
### Data insights across agencies
  ...
  * Using a common analytics tool across federal agencies will deliver [an unprecedented, government-wide view]({{< ref "guidance-for-dap-gov-wide-data.md" >}} "Guidance for DAP Gov-Wide Data") of how well agencies serve their customers through the Web.

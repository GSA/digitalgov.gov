---
permalink: /2014/03/25/trends-on-tuesday-testing-key-to-quality-mobile-products/
layout: post
...
Testing is an important part of any mobile app/web development and is why the Mobile Application Development Application program offers [mobile testing resources and guidelines](https://www.WHATEVER/2013/08/22/mobile-product-testing-guidelines/). The program also offers the opportunity to have your mobile web product tested with the [Federal Crowdsource Mobile Testing Program](https://www.WHATEVER/services/open-opportunities-mobile-application-testing-program/).